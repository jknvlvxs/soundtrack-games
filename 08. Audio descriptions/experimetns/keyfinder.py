...
# all credits go to jackmcarthur -> github.com/jackmcarthur/musical-key-finder
...
class Tonal_Fragment(object):
    ...
    # give the key, altkey, and their correlation scores... NOT BY THE ORIGINAL AUTHOR
    def give_key(self):
        return self.key, self.bestcorr, self.altkey, self.altbestcorr

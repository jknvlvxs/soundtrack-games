...
class StandardSolver(ABC, flashy.BaseSolver):
    ...
    def common_train_valid(self, dataset_split: str, **kwargs: tp.Any):
        ...
        # self.model.condition_provider.conditioners.visual_content.clip.visual.conv1.train(False)
        # self.model.condition_provider.conditioners.visual_content.clip.visual.ln_pre.train(False)
        # self.model.condition_provider.conditioners.visual_content.clip.visual.transformer.train(False)
